...
namespace DABugTracker.Services
{
    ...
    {
        private readonly string _defaultImage = "/images/DefaultUser.jpg";
        private readonly string _defaultBTUserImageSrc = "/images/DefaultUser.jpg";
        private readonly string _defaultCompanyImageSrc = "/images/DefaultUser.jpg";
        private readonly string _defaultProjectImageSrc = "/images/DefaultUser.jpg";
